...
/**
 * Data Transfer Object for retrieving supplier details.
 */
public class GetSupplierDto {
    ...
    /**
     * Constructs a GetSupplierDto with all fields.
     *
     ...
     */
    public GetSupplierDto(int id, String name, String phone, String email, String address) {
        this.id = id;
        this.name = name;
        this.phone = phone;
        this.email = email;
