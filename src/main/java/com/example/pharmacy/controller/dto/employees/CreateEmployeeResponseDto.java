...
/**
 * Data Transfer Object for responding with employee details after creation.
 */
public class CreateEmployeeResponseDto {
    ...
    /**
     * Constructs a response DTO with all employee details.
     *
     ...
     */
    public CreateEmployeeResponseDto(int id, String name, String position, BigDecimal salary, Date hireDate) {
        this.id = id;
        this.name = name;
